...
This is a thin wrapper that calls the actual implementation in servers/data_extraction.py.
...
Usage:
    python ehr_structurer.py --input input.jsonl --output output.jsonl \
        --deployment gpt-5.1 --prompts config/ehr_prompts.json
"""
...
from servers.data_extraction import main
