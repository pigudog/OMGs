# MDT Discussion Log — 2026-01-22_18-32-56
...
```
Final Assessment:
Post–primary surgery, adjuvant platinum, now on first‑line PARP maintenance with HRD‑positive disease, ECOG 1, no radiologic recurrence. Major concern is recurrent severe thrombocytopenia temporally related to maintenance. Missing: up‑to‑date CBC, renal/hepatic function, CA‑125, BRCA1/2 status, detailed current PARP dose/schedule, and full report of the “low‑density liver lesion.”

Core Treatment Strategy:
- Continue first‑line PARP maintenance in principle, but urgently reassess dose/intensity given recurrent severe thrombocytopenia. [@guideline:esmo_cpg_epithelialovarian_2023__v00000000 | Page 8; @pubmed | 40687421]  
- Obtain immediate CBC, coagulation, renal/hepatic function, CA‑125, and characterize liver lesion with dedicated imaging before firm long‑term decisions.  
- Schedule structured surveillance: symptom review, exam, CA‑125, and cross‑sectional imaging every 3–6 months while on maintenance. [@guideline:esgo_esmo_esp_consensus_ovariancancer_2024__v00000000 | Page 10]  

Change Triggers:
- If platelets remain <50×10⁹/L or other grade ≥3 cytopenias, hold/modify or discontinue PARP and involve hematology. [@pubmed | 40687421]  
- If imaging or CA‑125 indicates first recurrence, re‑stage fully and pivot to recurrence strategy with platinum‑based systemic therapy consideration. [@guideline:nccn_ovariancancer_v3_2025__v00000000 | Page 15]
...
[@guideline:esgo_esmo_esp_consensus_ovariancancer_2024__v00000000 | Page 10]
  Document: esgo_esmo_esp_consensus_ovariancancer_2024__v00000000, Page 10
  Content: platinum-based ChT followed by niraparib or rucaparib if
in...

[@guideline:nccn_ovariancancer_v3_2025__v00000000 | Page 15]
  Document: nccn_ovariancancer_v3_2025__v00000000, Page 15
  Content: and/or disease status.
ii Ancillary Palliative Surgical...
...
[
  ...
  {
    "ts": "2026-01-22T18:32:23.061279",
    "event": "rag_key_facts",
    "payload": {
      "facts": "DIAGNOSIS: primary=Ovarian cancer; histology=High-grade serous carcinoma; components=Adenocarcinoma;High-grade serous carcinoma\nPATHOLOGY: Adenocarcinoma consistent with high-grade serous carcinoma\nPLATINUM: status=Unknown; pfi_days=Unknown\nGENETICS: HRD=Positive; BRCA1=Unknown; BRCA2=Unknown\nBIOMARKERS: CA125=Unknown; AFP=Unknown; TMB=Unknown; MSI=Unknown; PDL1_CPS=Unknown"
    }
  },
  {
    "ts": "2026-01-22T18:32:45.139357",
    "event": "rag_query",
    "payload": {
      "query": "HRD-positive high-grade serous ovarian carcinoma, platinum-sensitive, with prior extensive peritoneal and nodal metastases; on niraparib maintenance complicated by severe thrombocytopenia but otherwise acceptable organ function; histology: High-grade serous carcinoma"
    }
  },
  {
    "ts": "2026-01-22T18:32:45.139369",
...
```
(Chair-SA(K): Knowledge only mode)
```
